...
CREATE TABLE `message`  (
  ...
  `userid1_or_sys` bigint(20) NULL DEFAULT NULL,
...
CREATE TABLE `room`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1050 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
